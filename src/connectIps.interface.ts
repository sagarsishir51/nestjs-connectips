...
export const CONNECT_IPS_PAYMENT_TEST_URL =
  "https://uat.connectips.com/connectipswebgw/loginpage";
export const CONNECT_IPS_PAYMENT_URL =
  "https://login.connectips.com/connectipswebgw/loginpage";
export const CONNECT_IPS_VALIDATE_TEST_URL =
  "https://uat.connectips.com/connectipswebws/api/creditor/validatetxn";
export const CONNECT_IPS_VALIDATE_URL =
...
type ConnectIpsAsyncOptions = Pick<ModuleMetadata, "imports"> &
